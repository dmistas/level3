...
<!--                                </div>-->
                                <form id="js-login" novalidate="" action="/register" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="emailverify" name="email" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nameverify" name="username" class="form-control"
                                               placeholder="Ваше имя" >
                                        <div class="invalid-feedback">Заполните поле.</div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="userpassword">Пароль <br></label>
                                        <input type="password" id="userpassword" name="password" class="form-control" placeholder="Пароль"
                                               required>
                                        <div class="invalid-feedback">Заполните поле.</div>
                                    </div>
